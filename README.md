...
10. Renderer          ASCII grid, cockpit HUD, 3D radar, starfield layers,
                      animated coronas, exotic compact objects (black hole
                      accretion discs, pulsar/magnetar beams), gravitational
                      lensing, comet ion tails, faction station silhouettes,
                      planetary rings, nebula clouds
